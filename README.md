...
Primarily, the program detects how much of either green, yellow, or red is found on the mango. Based on how much green is missing and red is showing, the program can tell if a mango is ripe or not. The major limiting factor is how much yellow is showing. For mangos, yellow tends to be both ripe and unripe depending on how much green or red is showing. Most commonly, yellow mangos are considered unripe more than ripe, so the program is trained to classify yellow mangos as unripe. This is evident when running the program using <a href="https://raw.githubusercontent.com/leeharry709/ripe-mango-detector/main/ripe%20mango%202.jpg">ripe mango 2.jpg</a>. The program will classify it as "unripe" since there is a high percentage of yellow in the picture. It is important to submit images that best capture the mango's color distribution to get an accurate result.
